...
static std::string ParamsToString(const double* params) {
  ...
  static_assert(num_params % 3 == 0, "Los parametros deben ser multiplos de 3");
  int a = 0;
  int n = 0;
  std::string result;
  for (int i = 0; i < num_params; ++i) {
...
static void CreateRenderWindow(sf::RenderWindow& window) {
  ...
  window.create(screenSize, "Ecuaciones del Caos", (fullscreen ? sf::Style::Fullscreen : sf::Style::Close), settings);
...
int main(int argc, char *argv[]) {
  std::cout << "=========================================================" << std::endl;
  std::cout << std::endl;
  std::cout << "                      Ecuaciones del Caos" << std::endl;
  std::cout << std::endl;
  std::cout << "Estas son graficas de ecuaciones recursivas aleatorias, que" << std::endl;
  std::cout << "a menudo producen caos y da como resultado hermosos patrones" << std::endl;
  std::cout << "las ecuaciones a iterar se producen a partir de un codigo de 6 letras." << std::endl;
  std::cout << "Por cada t, un punto (x, y) se inicializa en (t, t)." << std::endl;
  std::cout << "La ecuacion se aplica al punto muchas veces, y cada" << std::endl;
  std::cout << "iteracion se dibuja en un color unico." << std::endl;
  std::cout << std::endl;
  std::cout << "=========================================================" << std::endl;
  std::cout << std::endl;
  std::cout << "Controles:" << std::endl;
  std::cout << "      'A' - Modo automatico (ecuaciones aleatorias)" << std::endl;
  std::cout << "      'R' - Modo repeticion (Mantener la ecuacion actual)" << std::endl;
  std::cout << std::endl;
  std::cout << "      'C' - Centrar puntos" << std::endl;
  std::cout << "      'D' - Alternar dimension de puntos" << std::endl;
  std::cout << "      'I' - Alternar limite de iteraciones" << std::endl;
  std::cout << "      'T' - Alternar rastro" << std::endl;
  std::cout << std::endl;
  std::cout << "      'P' - Pausa" << std::endl;
  std::cout << " 'Izquierda' - Subir velocidad" << std::endl;
  std::cout << " 'Derecha' - Bajar velocidad" << std::endl;
  std::cout << "  'Espacio' - Reversa" << std::endl;
  std::cout << std::endl;
  std::cout << "     'N' - Nueva ecuacion (aleatoria)" << std::endl;
  std::cout << "     'L' - Cargar nuevo codigo de ecuacion" << std::endl;
  std::cout << "     'S' - Guardar ecuacion" << std::endl;
  std::cout << std::endl;
  ...
  if (!font.loadFromMemory(res_font.ptr, res_font.size)) {
    std::cerr << "FATAL: Error al cargar la fuente." << std::endl;
    system("pause");
    return 1;
  }
  ...
  while (true) {
    ...
    if (load_started) {
      std::string code;
      std::cout << "Ingresa un codigo de 6 letras:" << std::endl;
      std::cout << "NOTA:(no se reconocen caracteres especiales)." << std::endl;
      std::cin >> code;
      CreateRenderWindow(window);
      ResetPlot();
